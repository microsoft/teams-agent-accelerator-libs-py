...
from tests.memory_module.utils import create_test_assistant_message, create_test_memory, create_test_user_message
...
async def test_process_for_semantic_messages_enough_messages():
    ...
    messages = [
        ...
        create_test_assistant_message(content="That's great! How long have you been developing software?"),
...
async def test_process_for_semantic_messages_less_messages():
    ...
    messages = [
        ...
        create_test_user_message(content="Hey, I'm a software developer.", id="user_msg"),
    ]
    existing_memories = [
